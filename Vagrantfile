...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
	echo -e "https://dl-cdn.alpinelinux.org/alpine/v3.13/main" | tee -a /etc/apk/repositories &&
    echo -e "https://dl-cdn.alpinelinux.org/alpine/v3.13/community" | tee -a /etc/apk/repositories &&
	apk update &&
